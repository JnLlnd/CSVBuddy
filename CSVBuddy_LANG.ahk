...
global lTab1NewFileInstructions := "To create a new file, you must first enter the column names in the ""CSV File Header"" zone, separated by the field delimiter ( ~1~ ).`n`nFor example:`n`nFirst Name~1~Last Name~1~Phone Number`n`nWhen it is done, right-click again in the empty list."
