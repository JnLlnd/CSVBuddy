...
global lTab2SelectFieldMissingInReuse := "Field name ""~1~"" missing in the ""Select fields:"" zone.`n`nWhen building a reuse field, all fields in the existing header must be present in the ""Select fields:"" zone."
