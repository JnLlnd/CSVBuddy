...
global lLvEventsFieldsMissingChangeEditor := "~1~ cannot display all ~2~ fields using this ""Full Screen Editor"".`n`nTo edit all fiels, use the ""Field-by-field Editor"".`n`nGo to the ""Options"" tab and for ""Record Editor"", select ""Field-by-field Editor""."
...
global lLvEventsNoRecordSelected := "No record selected"
...
global lTab0BuildingMergeField := "Building merged field... (##%)"
...
global lTab0RestoringFromBackup := "Restoring data from backup... (##%)"
global lTab0Save := "3) Save CSV File"
global lTab0SavingBackupFromList := "Saving data backup from list... (##%)"
...
global lTab2HelpMerge := "Merge Fields$To create a new field by merging other fields, enter the merged field names enclosed by the delimiters ~2~ ~3~ (see ""Options"" tab) and the surrounding characters in the ""Merge fields"" text zone (example ""Full name: ~2~FirstName~3~ ~2~LastName~3~""); enter the name of the new field in ""New field name:"". The new field is added after the last column.`n`nClick ""Merge"" to process the merge fields. To save the file, click on the last tab ""3) Save CSV File""."
...
global lTab2Merge := "&Merge"
global lTab2MergeFields := "Merge fields:"
global lTab2MergeInvalid := "Merge syntax invalid:`n`n~1~"
global lTab2MergeNewName := "New field name:"
global lTab2MergeNoString := "First enter the merged fields enclosed in the merge delimiters ~1~field~2~ and the new field name.`n`nClick the Help button for more information."
global lTab2MergeDelimietInNewName := "Do not include merger delimiters ~1~ ~2~ in the new field name."
...
global lTab2SelectFieldExistingInMerge := "New field name ""~1~"" already exists in the current list. Choose another name."
global lTab2SelectFieldMissing := "Field name ""~1~"" in the ""Select fields:"" zone not found in the list."
global lTab2SelectFieldMissingInMerge := "Field name ""~1~"" not found in the current list.`n`nWhen building a new field, all merged fields must be present in the list."
...
global lTab6MergeDelimiters := "Merge delimiters:"
