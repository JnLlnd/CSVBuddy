...
global lTab1NewFile := "New file" ; ### USED???
global lTab1NewFileInstructions := "To create a new file, you must first enter the column names in the ""CSV File Header"" zone, separated by the field delimiter ( ~1~ ).`n`nFor example:`n`nFirst Name~1~Last Name~1~Phone Number"
...
global lTab5Abouttext2 := "<a href=""http://code.jeanlalonde.ca/ahk/csvbuddy/csvbuddy-doc.html#copyright"">Copyright Jean Lalonde " . chr(169) . "2013</a>`nSource: <a href=""https://github.com/JnLlnd/CSVBuddy"">GitHub</a>. Using AHK library: <a href=""https://www.github.com/JnLlnd/ObjCSV"">ObjCSV v0.3.1</a>`nUsing icon by: <a href=""http://www.visualpharm.com"">Visual Pharm</a>"
